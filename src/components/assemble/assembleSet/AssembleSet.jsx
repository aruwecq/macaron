...
export const products = [
    ...
    },
    {
      ...
      oldPrice: 1100,
      image:
        "https://macaronshop.ru/wp-content/uploads/2023/04/makaroni-12.png",
      count: 12,
    },
    {
      id: 3,
    ...
    },
    {
      ...
      oldPrice: 5900,
      image:
        "https://macaronshop.ru/wp-content/uploads/2023/01/makaroni-40.png",
      count: 40,
    },
    {
      id: 6,
      ...
      oldPrice: null,
      image:
        "https://macaronshop.ru/wp-content/uploads/2021/06/49-makaroni.png",
      count: 49,
    },
    {
      id: 7,
      ...
      oldPrice: null,
      image:
        "https://macaronshop.ru/wp-content/uploads/2024/06/makaroni-60.png",
      count: 60,
    },
  ];
      ...
      <div className="products">
        {products.map((p) => (
          <div className="product-card" key={p.id}>
            <Link to={`/sobratnabor/${p.id}`} className="aa">
